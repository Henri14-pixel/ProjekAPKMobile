...
public class AppProfileActivity extends AppCompatActivity {
    ...
    private static final String TAG = AppProfileActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnLogout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                myWebView.loadUrl("http://192.168.43.29/KapronPetshop/API/logout");
        ...
        URL = "http://192.168.43.29/KapronPetshop/app/user-profile?lid=" + id + "&lpwd=" + pwd;
        ...
        mBottomNavigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navHome:
                        finish();
                        Intent Home = new Intent(AppProfileActivity.this, DashboardActivity.class);
                        startActivity(Home);
                        break;
                    case R.id.navCart:
                        Intent Cart = new Intent(AppProfileActivity.this, CartActivity.class);
                        startActivity(Cart);
                        break;
                    case R.id.navHistory:
                        Intent History = new Intent(AppProfileActivity.this, HistoryActivity.class);
                        startActivity(History);
                        break;
                    case R.id.navProfile:
                        Intent Profile = new Intent(AppProfileActivity.this, AppProfileActivity.class);
        ...
        pd = new ProgressDialog(AppProfileActivity.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.getBoolean("success")) {
                                ...
                                AdapterUser.getInstance(getApplicationContext()).clearData();
